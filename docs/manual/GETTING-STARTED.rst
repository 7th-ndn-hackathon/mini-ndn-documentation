...
(ctrl+c) is reserved for the purpose of stopping applications initiated
on the minindn command line.
...
Autocomplete of command-line options is available for users of Bash and
Zsh.
...
Topology files given under ndn\_utils/topologies/minindn\* have
